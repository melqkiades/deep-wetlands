...
def export_ndwi_mask_data_new(config, tiles, tif_file, patch_size, date, area_name='Orebro lan'):
    # patch_size = int(os.getenv('PATCH_SIZE'))
...
def full_cycle(config):
    ...
    tif_files = ["/mimer/NOBACKUP/groups/deep-wetlands-data-2025/data/ndwi_masks/Orebro lan/Orebro lan_mosaic_2020-05-30_ndwi.tif"]
    ...
    for tif_file in tif_files:
        ...
        export_ndwi_mask_data_new(config, tiles, tif_file, patch_size, '2020-05-30', 'Orebro lan')
